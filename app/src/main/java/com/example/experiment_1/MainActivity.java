...
public class MainActivity extends AppCompatActivity {
    ...
    //平方
    public static Double Squ(Double d1){
        if(d1==Double.NEGATIVE_INFINITY||d1==Double.POSITIVE_INFINITY){
            return d1*d1;
        }
        if(String.valueOf(d1).equals("NaN")||String.valueOf(d1).equals("NaN")){
            return d1*d1;
        ...
        BigDecimal b1=new BigDecimal(Double.toString(d1));
        return b1.pow(2).doubleValue();
    }
    //根号
    public static Double Sqr(Double d1){
        if(d1==Double.NEGATIVE_INFINITY||d1==Double.POSITIVE_INFINITY){
            return Math.sqrt(d1);
        }
        if(String.valueOf(d1).equals("NaN")||String.valueOf(d1).equals("NaN")){
    ...
    //立方
    public static Double Cube(Double d1){
        if(d1==Double.NEGATIVE_INFINITY||d1==Double.POSITIVE_INFINITY){
            return d1*d1*d1;
        }
        if(String.valueOf(d1).equals("NaN")||String.valueOf(d1).equals("NaN")){
    ...
    protected String calculate(ArrayList equation){
        ...
        for(int i=0;i<equation.size();i++)
        {
            ...
            else if(temp4.equals("²")||temp4.equals("√")||temp4.equals("³"))
            {
                temp2=operand.get(operand.size()-1);
                operand.remove(operand.size()-1);
                if(temp4.equals("²"))
                {   result=Squ(temp2);operand.add(result);}
                else if(temp4.equals("√"))
                {   result=Sqr(temp2);operand.add(result);}
                else if(temp4.equals("³"))
                {   result=Cube(temp2);operand.add(result);}
